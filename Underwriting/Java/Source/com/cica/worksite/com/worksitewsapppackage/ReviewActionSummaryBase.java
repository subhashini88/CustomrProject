...
public abstract class ReviewActionSummaryBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(ReviewActionSummary.class);
            s_classInfo.setTableName("ReviewActionSummary");
    ...
    public ReviewActionSummaryBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static BusObjectIterator<com.worksitewsapppackage.ReviewActionSummary> getNextReviewActionSummaryObjects(long ActId, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"ReviewActionSummary\" where (\"ActId\" > :ActId) order by \"ActId\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(ActId));//NOPMD
        query.setResultClass(ReviewActionSummary.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.worksitewsapppackage.ReviewActionSummary> getPreviousReviewActionSummaryObjects(long ActId, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"ReviewActionSummary\" where (\"ActId\" < :ActId) order by \"ActId\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(ActId));//NOPMD
        query.setResultClass(ReviewActionSummary.class);
        query.setCursor(cursor);
    ...
    public static com.worksitewsapppackage.ReviewActionSummary getReviewActionSummaryObject(long ActId)
    {
        String queryText = "select * from \"ReviewActionSummary\" where \"ActId\" = :ActId";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("ActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(ActId));//NOPMD
        query.setResultClass(ReviewActionSummary.class);
    ...
    public static BusObjectIterator<com.worksitewsapppackage.ReviewActionSummary> getReviewActionSummaryObjects(long fromActId, long toActId, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"ReviewActionSummary\" where \"ActId\" between :fromActId and :toActId";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(fromActId));
        query.addParameter("toActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(toActId));
        query.setResultClass(ReviewActionSummary.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.worksitewsapppackage.ReviewActionSummary> getReviewActionSummaryObjects(long fromActId, long toActId)
    {
        String queryText = "select * from \"ReviewActionSummary\" where \"ActId\" between :fromActId and :toActId";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromActId", "ReviewActionSummary.ActId", QueryObject.PARAM_INT, new Long(fromActId));
