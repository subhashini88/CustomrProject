...
public abstract class tblPostIssueDetails_worksheetBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(tblPostIssueDetails_worksheet.class);
            s_classInfo.setTableName("tblPostIssueDetails_worksheet");
    ...
    public tblPostIssueDetails_worksheetBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static BusObjectIterator<com.cica.uw.tblPostIssueDetails_worksheet> getNextTblPostIssueDetails_worksheetObjects(int Obj_id, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblPostIssueDetails_worksheet\" where (\"obj_id\" > :Obj_id) order by \"obj_id\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("Obj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(Obj_id));//NOPMD
        query.setResultClass(tblPostIssueDetails_worksheet.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.cica.uw.tblPostIssueDetails_worksheet> getPreviousTblPostIssueDetails_worksheetObjects(int Obj_id, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblPostIssueDetails_worksheet\" where (\"obj_id\" < :Obj_id) order by \"obj_id\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("Obj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(Obj_id));//NOPMD
        query.setResultClass(tblPostIssueDetails_worksheet.class);
        query.setCursor(cursor);
    ...
    public static com.cica.uw.tblPostIssueDetails_worksheet getTblPostIssueDetails_worksheetObject(int Obj_id)
    {
        String queryText = "select * from \"tblPostIssueDetails_worksheet\" where \"obj_id\" = :Obj_id";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("Obj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(Obj_id));//NOPMD
        query.setResultClass(tblPostIssueDetails_worksheet.class);
        return (tblPostIssueDetails_worksheet)query.getObject();
    }

    public static BusObjectIterator<com.cica.uw.tblPostIssueDetails_worksheet> getTblPostIssueDetails_worksheetObjects(int fromObj_id, int toObj_id, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblPostIssueDetails_worksheet\" where \"obj_id\" between :fromObj_id and :toObj_id";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromObj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(fromObj_id));
        query.addParameter("toObj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(toObj_id));
        query.setResultClass(tblPostIssueDetails_worksheet.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.cica.uw.tblPostIssueDetails_worksheet> getTblPostIssueDetails_worksheetObjects(int fromObj_id, int toObj_id)
    {
        String queryText = "select * from \"tblPostIssueDetails_worksheet\" where \"obj_id\" between :fromObj_id and :toObj_id";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromObj_id", "tblPostIssueDetails_worksheet.obj_id", QueryObject.PARAM_INT, new Integer(fromObj_id));
