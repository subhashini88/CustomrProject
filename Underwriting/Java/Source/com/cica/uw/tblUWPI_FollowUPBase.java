...
public abstract class tblUWPI_FollowUPBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(tblUWPI_FollowUP.class);
            s_classInfo.setTableName("tblUWPI_FollowUP");
    ...
    public tblUWPI_FollowUPBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static BusObjectIterator<com.cica.uw.tblUWPI_FollowUP> getNextTblUWPI_FollowUPObjects(int SLNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblUWPI_FollowUP\" where (\"SLNO\" > :SLNO) order by \"SLNO\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(SLNO));//NOPMD
        query.setResultClass(tblUWPI_FollowUP.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.cica.uw.tblUWPI_FollowUP> getPreviousTblUWPI_FollowUPObjects(int SLNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblUWPI_FollowUP\" where (\"SLNO\" < :SLNO) order by \"SLNO\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(SLNO));//NOPMD
        query.setResultClass(tblUWPI_FollowUP.class);
        query.setCursor(cursor);
    ...
    public static com.cica.uw.tblUWPI_FollowUP getTblUWPI_FollowUPObject(int SLNO)
    {
        String queryText = "select * from \"tblUWPI_FollowUP\" where \"SLNO\" = :SLNO";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(SLNO));//NOPMD
        query.setResultClass(tblUWPI_FollowUP.class);
        return (tblUWPI_FollowUP)query.getObject();
    }

    public static BusObjectIterator<com.cica.uw.tblUWPI_FollowUP> getTblUWPI_FollowUPObjects(int fromSLNO, int toSLNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"tblUWPI_FollowUP\" where \"SLNO\" between :fromSLNO and :toSLNO";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromSLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(fromSLNO));
        query.addParameter("toSLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(toSLNO));
        query.setResultClass(tblUWPI_FollowUP.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.cica.uw.tblUWPI_FollowUP> getTblUWPI_FollowUPObjects(int fromSLNO, int toSLNO)
    {
        String queryText = "select * from \"tblUWPI_FollowUP\" where \"SLNO\" between :fromSLNO and :toSLNO";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromSLNO", "tblUWPI_FollowUP.SLNO", QueryObject.PARAM_INT, new Integer(fromSLNO));
